...
export default function 注册菜单() {
    ...
    noobApi.自定义菜单.引用块菜单.注册自定义菜单项({
        id:'移动为子文档',
        文字:'移动引用目标所在文档为子文档',
        图标: `#iconMove`,

        点击回调函数:async()=>{
            根据目标id移动块所在文档(noobApi.自定义菜单.引用块菜单.菜单状态.引用目标id, noobApi.自定义菜单.引用块菜单.菜单状态.所在块id) 
        }
    })
    noobApi.自定义菜单.引用块菜单.注册自定义菜单项({
        id:'移动当前文档为子文档',
        ...
        点击回调函数:async()=>{
            根据目标id移动块所在文档(noobApi.自定义菜单.引用块菜单.菜单状态.所在块id,noobApi.自定义菜单.引用块菜单.菜单状态.引用目标id) 
        }
    })
