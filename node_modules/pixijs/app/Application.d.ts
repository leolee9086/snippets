...
import type { Rectangle, IRendererOptionsAuto, IRenderer } from 'pixijs/core';
...
export declare class Application<VIEW extends ICanvas = ICanvas> {
     ...
     *   option only is available when using **pixijs/browser/legacy** or **pixijs/renderer/canvas** modules, otherwise
     *   it is ignored.
